...
import co.edu.unbosque.model.persistencie.GestorColisiones;
import co.edu.unbosque.model.persistencie.GestorTurnos;
import co.edu.unbosque.model.persistencie.HistorialDAO;
import co.edu.unbosque.model.persistencie.JugadorDAOImpl;
import co.edu.unbosque.model.persistencie.RankingDAO;
import co.edu.unbosque.model.persistencie.TableroDAO;
 ...
 *
 * <p>El JuegoController interactua exclusivamente con esta clase
 * para toda la logica de negocio. No se usan ciclos (for/while/do-while);
 * todos los recorridos de listas son recursivos.</p>
 *
 * @author Estudiante
 * @version 1.0
 */
public class ModelFacade {
     ...
     */
    public void iniciarPartida(String[] nombresJugadores)
    ...
    public String ejecutarTurno() throws PartidaNoIniciadaException, PosicionInvalidaException {
        if (!partidaEnCurso) {
            throw new PartidaNoIniciadaException("No hay una partida en curso.");
        }

        JugadorDTO jugadorActual = gestorTurnos.obtenerJugadorActual();
        if (jugadorActual == null) {
            throw new PartidaNoIniciadaException("No hay jugadores activos en la cola de turnos.");
        }
