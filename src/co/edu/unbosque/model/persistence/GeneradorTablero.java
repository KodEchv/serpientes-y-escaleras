...
public class GeneradorTablero {
    ...
    /**
     * Genera la lista de serpientes de forma recursiva con la cantidad exacta indicada.
     *
     * @param cantidad Numero exacto de serpientes a generar.
     ...
     */
    public MyLinkedList<SerpienteDTO> generarSerpientes(int cantidad) throws PosicionInvalidaException {
    ...
    /**
     * Genera la lista de escaleras de forma recursiva con la cantidad exacta indicada.
     *
     * @param cantidad Numero exacto de escaleras a generar.
     ...
     */
    public MyLinkedList<EscaleraDTO> generarEscaleras(int cantidad) throws PosicionInvalidaException {
