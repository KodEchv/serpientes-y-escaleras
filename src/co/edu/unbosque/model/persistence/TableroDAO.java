...
public class TableroDAO {
    ...
    /**
     * Construye el tablero completo con la cantidad exacta de serpientes y escaleras indicada.
     *
     * @param cantSerpientes Numero exacto de serpientes a colocar en el tablero.
     * @param cantEscaleras  Numero exacto de escaleras a colocar en el tablero.
     * @throws PosicionInvalidaException Si la generacion no puede cumplir las restricciones.
     * @throws EstructuraVaciaException  Si el grafo queda vacio tras la construccion.
     */
    public void construirTablero(int cantSerpientes, int cantEscaleras)
        ...
        // 3. Generar y aplicar serpientes (cantidad exacta del usuario)
        MyLinkedList<SerpienteDTO> serpientes = generador.generarSerpientes(cantSerpientes);
        aplicarSerpientes(serpientes.getFirst());

        // 4. Generar y aplicar escaleras (cantidad exacta del usuario)
        MyLinkedList<EscaleraDTO> escaleras = generador.generarEscaleras(cantEscaleras);
